drop database IF EXISTS nailldb;

create database nailldb;
...
#用户
insert into userinfo(loginname,loginpwd,realname,typeid,logintime,logouttime) values('aaa','aaa','赵宁',1,null,null);
insert into userinfo(loginname,loginpwd,realname,typeid,logintime,logouttime) values('admin','admin','刘立立',2,null,null);
insert into userinfo(loginname,loginpwd,realname,typeid,logintime,logouttime) values('zhaoning','zhaoning','赵宁',2,null,null);

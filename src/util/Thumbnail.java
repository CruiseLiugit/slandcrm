...
public class Thumbnail {
	 ...
	 * @throws IOException
	 */
	public Thumbnail(String fromFileName,String toFileName) throws IOException {
		File _file = new File(fromFileName); // 读入文件
		this.srcFile = _file.getName();
		//this.destFile = "/Users/SDJG/Desktop/big_2.jpg";
		this.destFile = toFileName;
	...
	public static void main(String[] args) throws Exception {
		Thumbnail ccc = new Thumbnail("/Users/SDJG/Desktop/big_190949302.jpg","/Users/SDJG/Desktop/sm_87878.jpg");

...
<body class="">
	...
	<div class="content">
		...
		<ul class="breadcrumb">
			...
			<li><a
				href="${pageContext.request.contextPath}/comments!findUnCheckComment.action">评论</a>
				<span class="divider">/</span>
			</li>
			<li class="active">管理评论</li>
		</ul>
			...
			<div class="row-fluid">
				...
				<div class="block">
					...
					<table class="table">
						...
						<tbody>
							<s:iterator value="#request.uncheckcomments_list" var="peris">
								<tr>
									<td><s:property value="#peris.periodical.id" /></td>
									<td><s:property value="#peris.topic.id" /></td>
									<td><s:property value="#peris.comment" /></td>
									<td><s:property value="#request.time" /></td>
									<td>批准</td>
								</tr>
							</s:iterator>
						</tbody>
